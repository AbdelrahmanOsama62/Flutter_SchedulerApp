...
import 'package:schedulerapp/services/notification_services.dart';
...
import 'package:schedulerapp/ui/add_task_bar.dart';
import 'package:schedulerapp/controllers/task_controller.dart';
import 'package:flutter_staggered_animations/flutter_staggered_animations.dart';
import 'package:schedulerapp/ui/widgets/task_tile.dart';
      ...
      return ListView.builder(
          ...
          itemBuilder: (_, index){
            ...
            if(task.repeat=='Daily'){
              DateTime date = DateFormat.jm().parseStrict(task.startTime.toString());
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            label,
            style: isClose? Themes().TitleStyle.copyWith(fontSize: 18):Themes().TitleStyle.copyWith(color: Colors.white,fontSize: 18),
          ),
        ),
      ),
    );
    ...
    Container(
      ...
      child: Column(
        children: [
          ...
          task.isCompleted==1?
              Container():
              _bottomSheetButton(label: "Task Completed", onTap: (){_taskController.markTaskCompleted(task.id!);Get.back();}, clr: prcolor,context:context),
